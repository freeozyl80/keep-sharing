(() => {
  ...
  function collectDataFromConstructor(vm, Component3) {
    ...
    if (true) {
      if (!(Component3.prototype instanceof vue_runtime_esm_default) && Object.keys(plainData).length > 0) {
        warn2("Component class must inherit Vue or its descendant class when class property is used.");
      }
    }
    return plainData;
  }
  ...
  function componentFactory(Component3) {
    ...
    (options.mixins || (options.mixins = [])).push({
      data: function data() {
        return collectDataFromConstructor(this, Component3);
      }
    });
    ...
    var Super = superProto instanceof vue_runtime_esm_default ? superProto.constructor : vue_runtime_esm_default;
    var Extended = Super.extend(options);
    forwardStaticMembers(Extended, Component3, Super);
    if (reflectionIsSupported()) {
      copyReflectionMetadata(Extended, Component3);
    }
    return Extended;
  }
  ...
  function forwardStaticMembers(Extended, Original, Super) {
    Object.getOwnPropertyNames(Original).forEach(function(key) {
      ...
      if (reservedPropertyNames.indexOf(key) >= 0) {
        warn2("Static property name '".concat(key, "' declared on class '").concat(Original.name, "' ") + "conflicts with reserved property name of Vue internal. It may cause unexpected behavior of the component. Consider renaming the property.");
      }
  ...
  function Component(options) {
    ...
    return function(Component3) {
      return componentFactory(Component3, options);
    };
  }
  ...
  // ../node_modules/vue-tsx-support/dist/esm/api.js
  ...
  function createComponentFactory(base, mixins2) {
    return {
      create: function(options) {
        var mergedMixins = options.mixins ? __spreadArrays(options.mixins, mixins2) : mixins2;
        return base.extend(__assign(__assign({}, options), { mixins: mergedMixins }));
      },
      mixin: function(mixinObject) {
        return createComponentFactory(base, __spreadArrays(mixins2, [mixinObject]));
      }
    };
  }
  function createExtendableComponentFactory() {
    return {
      create: function(options) {
        return vue_runtime_esm_default.extend(options);
      },
      extendFrom: function(base) {
        return createComponentFactory(base, []);
      },
      mixin: function(mixinObject) {
        return createComponentFactory(vue_runtime_esm_default, [mixinObject]);
      }
    };
  }
  var componentFactory2 = createExtendableComponentFactory();
  var component = componentFactory2.create;
  var extendFrom = componentFactory2.extendFrom;

  // ../node_modules/vue-tsx-support/dist/esm/modifiers.js
  ...
  function defineChildModifier(target2, currentFilters, name, filter, children) {
    Object.defineProperty(target2, name, {
      get: function() {
        var ret = createModifier(__spreadArrays2(currentFilters, [filter]), children);
        Object.defineProperty(target2, name, {
          value: ret,
          enumerable: true
        });
  ...
  function defineKeyCodeModifiers(target2, filters, children) {
    var _loop_1 = function(name_12) {
      ...
      if (typeof code === "number") {
        defineChildModifier(target2, filters, keyName, function(e) {
  ...
  function defineKeys(target2, filters, children) {
    Object.defineProperty(target2, "keys", {
      get: function() {
        var _this = this;
  ...
  function defineExact(target2, filters, children) {
    Object.defineProperty(target2, "exact", {
      get: function() {
        var _this = this;
  ...
  function createModifier(filters, children) {
    ...
    if (children.keyboard || children.mouse) {
      var nextChildren = __assign2(__assign2({}, children), { keyboard: false, mouse: false });
    ...
    if (children.exact) {
      var nextChildren = __assign2(__assign2({}, children), { exact: false, modkey: false });
      defineExact(m, filters, nextChildren);
    }
    if (children.modkey) {
      var nextChildren = __assign2(__assign2({}, children), { exact: false });
  ...
  // ../Page/Page.tsx
  var MyComponent = componentFactory2.create({
    props: {
    ...
    render() {
      return /* @__PURE__ */ VueTsxSupport("span", {
        class: this.className,
        onClick: this.onClick
      }, this.text);
    }
  });
  var Page_default = MyComponent;

  // ../App.tsx
  var App = class extends vue_runtime_esm_default {
    render() {
      console.log("japhy");
      return /* @__PURE__ */ VueTsxSupport("div", {
        id: "wrapper"
      }, /* @__PURE__ */ VueTsxSupport(Page_default, {
        text: "data"
      }));
    }
  };
